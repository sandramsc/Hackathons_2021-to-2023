...
function PaymentMethodList({ title, paymentmethod }) {
  const renderPaymentMethod = paymentmethod.map(({ image, name, description, action }) => (
...
// Typechecking props for the PaymentMethodList
PaymentMethodList.propTypes = {
  title: PropTypes.string.isRequired,
  paymentmethod: PropTypes.arrayOf(PropTypes.object).isRequired,
};
